...
import com.icsseseguridad.locationsecurity.view.adapter.ClerkModelAdapter;
...
public class ClerkSearchDialog<T extends Searchable> extends BaseSearchDialogCompat<T> {

    private String mTitle;
    private String mSearchHint;
    private SearchResultListener<T> mSearchResultListener;

    public ClerkSearchDialog(Context context, String title, String searchHint,
    ...
    protected void getView(View view) {
        ...
        final ClerkModelAdapter adapter = new ClerkModelAdapter<>(getContext(),
    ...
    public ClerkSearchDialog setTitle(String title) {
        mTitle = title;
        return this;
    }

    public ClerkSearchDialog setSearchHint(String searchHint) {
        mSearchHint = searchHint;
        return this;
    }

    public ClerkSearchDialog setSearchResultListener(
            SearchResultListener<T> searchResultListener) {
        mSearchResultListener = searchResultListener;
        return this;
    }
