...
public class VisitActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.visit = gson().fromJson(getIntent()
                .getStringExtra(ControlVisit.class.getName()), ControlVisit.class);
        setupVehicle(this.visit.vehicle);
        setupVisitor(this.visit.visitor);
        setupClerk(this.visit.clerk);
        setupMaterials(this.visit);

        finishButton.setImageDrawable(getResources().getDrawable(R.drawable.icon_exit));
        ((View) finishButton).setVisibility(this.visit.status == 0? View.GONE: View.VISIBLE);
    }
