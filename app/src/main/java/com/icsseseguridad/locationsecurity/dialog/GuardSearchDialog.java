...
import com.icsseseguridad.locationsecurity.adapter.GuardModelAdapter;
...
public class GuardSearchDialog<T extends Searchable> extends BaseSearchDialogCompat<T> {

    private String mTitle;
    private String mSearchHint;
    private SearchResultListener<T> mSearchResultListener;

    public GuardSearchDialog(Context context, String title, String searchHint,
    ...
    protected void getView(View view) {
        ...
        final GuardModelAdapter adapter = new GuardModelAdapter<>(getContext(),
    ...
    public GuardSearchDialog setTitle(String title) {
        mTitle = title;
        return this;
    }

    public GuardSearchDialog setSearchHint(String searchHint) {
        mSearchHint = searchHint;
        return this;
    }

    public GuardSearchDialog setSearchResultListener(
            SearchResultListener<T> searchResultListener) {
        mSearchResultListener = searchResultListener;
        return this;
    }
    ...
    public ArrayList<T> customFilter(String text) {
        ...
        for (T item : getItems()) {
            if (normalize(((Guard) item).dni).contains(normalize(text)) ||
                    normalize(((Guard) item).getFullname()).contains(normalize(text)) ){
